  ...
  return (
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative glass">
          <iframe
            width="100%"
            height="100%"
            title="map"
          ...
          />
          <div className="bg-gray-900 bg-opacity-90 relative flex flex-wrap py-6 rounded shadow-md glass">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <p className="leading-relaxed">512-400-9675</p>
            </div>
          </div>
        </div>
        <form
